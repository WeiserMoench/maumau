...
public interface services {
	 ...
	 */
	public void auswaehlenKartendeck(Spiel spiel,int kartenblatt);
	/**
	 ...
	 */
	public void auswaehlenSpielerFuerSpiel(Spiel spiel);//registerieren von spielern, spielerparameter
	/**
	...
	public void austeilenvonKarten();
	/**
	 ...
	 */
	public void legenKarteAufAblageStapel(Spiel spiel, Spieler spieler, boolean sichtbarLegen, int abzulegendeKarte);
	/**
	 ...
	 */
	public void aendernSpielrichtung(Spiel spiel);//da methode nur aufgerufen wird, wenn benoetigt, tauscht er einfach true gegen fals, somit ist kein Parameter erforderlich
	/**
